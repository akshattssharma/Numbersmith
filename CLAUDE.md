...
- `README.md` — the full "Findings from building it" log (21 entries as of this writing) documents every non-obvious bug and the reasoning behind fixes already made; check it before re-deriving something that was already tried and found wrong.
